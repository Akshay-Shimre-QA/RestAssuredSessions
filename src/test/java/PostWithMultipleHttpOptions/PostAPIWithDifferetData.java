package PostWithMultipleHttpOptions;
...
public class PostAPIWithDifferetData {
	...
	public void bodyWithMultiPartTest() {
		...
		given().log().all()
			...
			.multiPart("filename", new File("C:\\Users\\Akshay\\OneDrive\\Desktop\\NSR Payment.png"))
	...
	public void bodyWithPdfFileTest() {
		...
		given().log().all()
			...
			.body(new File("C:\\Users\\Akshay\\OneDrive\\Desktop\\DT20222783239_Akanksha suresh shimre.pdf"))
			.when()
				.post("/post")
				.then().log().all()
				.assertThat()
